...
using Utility;
using BITCollege_ADU.Data;
using System.Data.SqlClient;
using System.Data;

namespace BITCollege_ADU.Models
{
    /// <summary>
    ...
    {
        private BITCollege_ADUContext db = new BITCollege_ADUContext();
    ...
    {
        protected static BITCollege_ADUContext db = new BITCollege_ADUContext();
    ...
    public static class StoredProcedure
    {
        ...
        public static long? NextNumber(String discriminator)
        {
            try
            {
                ...
                "Initial Catalog=BITCollege_ADUContext;Integrated Security=True");
